...
Name: SteamOS Atomic Updater
Version: 0.20190711.0
Summary: SteamOS Atomic Update - Python library that is used by both the client and the server.
Home-page: https://store.steampowered.com/steamos/
Author: Arnaud Rebillout
Author-email: arnaud.rebillout@collabora.com
License: LGPL-2.1
Description: SteamOS Atomic Update
        =====================
